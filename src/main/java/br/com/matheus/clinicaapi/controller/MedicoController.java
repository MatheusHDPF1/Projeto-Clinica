...
import br.com.matheus.clinicaapi.repository.MedicoRepository;

@RestController
@RequestMapping("/medico")
public class MedicoController {
	/*
	 * A anotação Autowired gera um objeto do MedicoRepository em
	 * tempo de execução, ou seja,
	...
	public Optional<Medico> pesquisarId(@PathVariable Long id) {
	...
	public String apagar(@PathVariable Long id) {
		mr.deleteById(id);
		return "Médico apagado com sucesso";
